...
class Batter(Player):
    ...
    def _get_default_stats(self):
        # over 60% of batters hit right
        self.stand = "R"

        pitch_types = ["CH", "CU", "FC", "FF", "FS", "KC", "SI", "SL", "ST", "SV"]
        self.pitch_woba = {pitch: 0.0 for pitch in pitch_types}
        self.pitch_strike = {pitch: 0.0 for pitch in pitch_types}
