...
from mlb_simulator.models.pitching.pitch_characteristics import (
...
class Pitcher(Player):
    def __init__(self, mlb_id=None, rotowire_id=None, backtest_date=""):
        ...
        self.throws = query_mlb_db(
            f"""select p_throws from Statcast where
